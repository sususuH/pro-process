...
coco_format_save_path='D:\\Code\\SF2023\\smoke-fire\\val\\'   #要生成的标准coco格式标签所在文件夹
yolo_format_classes_path='D:\\Code\\SF2023\\smoke-fire\\names.txt'     #类别文件，一行一个类
yolo_format_annotation_path='D:\\Code\\SF2023\\smoke-fire\\labels\\val\\'  #yolo格式标签所在文件夹
img_pathDir='D:\\Code\\SF2023\\smoke-fire\\images\\val\\'    #图片所在文件夹
