...
if __name__ == '__main__':
    # train 从train中移动
    train_img_Dir = '/home/su/su/labels_crop1-8/test/image_yolo_txt_train/images/'
    train_mask_Dir = '/home/su/su/labels_crop1-8/test/image_yolo_txt_train/labels/'
    # test路径：图片和标注目录
    #test_img_Dir = ''
    #test_mask_Dir = ''
    # val路径：图片和标注文目录
    val_img_Dir = '/home/su/su/labels_crop1-8/test/image_yolo_txt_val/images/'
    val_mask_Dir = '/home/su/su/labels_crop1-8/test/image_yolo_txt_val/labels/'
    # 运行划分数据集函数
